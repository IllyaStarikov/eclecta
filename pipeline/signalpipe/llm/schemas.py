...
SYSTEM_WRITE = (
    ...
    "Be unbiased: report claims as claims, attribute them, flag missing "
    "evidence. Never invent facts not in the provided text. Prefer commas, "
    "colons, and periods over em dashes; no exclamation marks. "
    + READER_PROFILE
    + " Respond ONLY with JSON matching the provided schema."
)
